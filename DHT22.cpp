...
DHT22::DHT22(uint8_t pin, uint8_t count) {
  ...
  _maxcycles = microsecondsToClockCycles(1000);  // 1 millisecond timeout for
                                                 // reading pulses from DHT22 sensor.
  // Note that count is now ignored as the DHT22 reading algorithm adjusts itself
...
float DHT22::computeHeatIndex(float temperature, float percentHumidity, bool isFahrenheit) {
...
boolean DHT22::read(bool force) {
  ...
  // Send start signal.  See DHT22 datasheet for full signal diagram:
